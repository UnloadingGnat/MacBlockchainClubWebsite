...
export default function WebsiteLink({ className }: { className: string }) {
    return (
        <svg className="h-5 w-5 ml-[0.5px]" width="20" height="20" viewBox="0 0 24 24" fill="transparent" xmlns="http://www.w3.org/2000/svg">
