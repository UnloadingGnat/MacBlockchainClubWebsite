...
import { art } from "@/components/home/ascii-art";
...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <div className="mt-[-50px] flex min-h-screen w-11/12 flex-col items-center justify-center bg-[#962845]">
        <div className="mt-[-40%] md:mt-[-15%]">
          ...
          >
            ...
            <pre className="lg:text-md absolute hidden translate-y-1/2 md:text-xs lg:block lg:-translate-x-[15%] xl:-translate-x-[10%]">
              {art}
            </pre>
            <motion.h1
        ...
        <div className="flex gap-4">
          <Link href="/events" className="z-20">
            <button className="z-20 rounded-full border border-black bg-black p-2 px-10 text-lg font-semibold text-white transition-all hover:bg-white hover:text-black">
              Events
            </button>
          </Link>
          <button
      ...
      <div className="z-20 mt-[-50px] flex min-h-screen w-11/12 flex-col items-center justify-center bg-[#0d0c0c] pb-11">
        ...
        <div className="mt-[50px] w-11/12 md:mt-16">
          ...
          <div className="grid grid-cols-1 gap-4  md:sm:grid-cols-3 md:mt-14">
            <div className="flex flex-col gap-5 border-2 border-[#322e2c] bg-[#131211] p-4 shadow-md md:h-56 md:hover:border-[#962845]">
            ...
            <div className="flex flex-col gap-5 border-2 border-[#322e2c] bg-[#131211] p-4 shadow-md md:h-56 md:hover:border-[#C2EBC4]">
            ...
            <div className="flex flex-col gap-5 border-2 border-[#322e2c] bg-[#131211] p-4 shadow-md md:h-56 md:hover:border-[#B3D9FF]">
      ...
      <div className="z-20 mt-12 flex min-h-[6rem] w-11/12 flex-col items-start justify-start bg-white">
        ...
        <div className="grid w-11/12 grid-cols-1 gap-1 self-center md:mt-14 md:ml-[10%] md:grid-cols-2">
          <div className="flex w-[100%] flex-col items-start justify-center gap-5 bg-black p-4 md:w-[80%]">
            <div className="ml-[10%]">
              ...
              <a href={email} className="group mt-5 flex items-center gap-3">
                <button className="mt-3 h-9 w-9 rounded-full bg-[#45403d] text-2xl text-white group-hover:bg-[#962845]">
                  →
                </button>
          ...
          <div className="flex w-[100%] flex-col items-start justify-center gap-5 bg-black p-4 md:h-56 md:w-[80%]">
            <div className="ml-[10%]">
